...
export class GridComponent implements OnInit {
  ...
  public recipes: RecipeI[] = [];
  public visibleRecipes: RecipeI[] = [];
  ...
  private initPagination(recipes: RecipeI[]) {
    this.totalPages = Math.ceil(recipes.length / this.recipesPerPage);
  }

  private setRecipes(recipes: RecipeI[]) {
  ...
  public viewRecipe(recipe: RecipeI) {
